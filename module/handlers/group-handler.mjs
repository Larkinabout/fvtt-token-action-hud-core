...
export class GroupHandler {
  ...
  createGroup(groupData, keepData = false) {
    ...
    const commonProps = {
      ...
      ...(groupDataClone.icon && { icon: groupDataClone.icon }),
      ...(groupDataClone.icon1 && { icon1: groupDataClone.icon1 }),
      ...(groupDataClone.icon2 && { icon2: groupDataClone.icon2 }),
      ...(groupDataClone.icon3 && { icon3: groupDataClone.icon3 }),
      ...(groupDataClone.icons && { icons: groupDataClone.icons }),
