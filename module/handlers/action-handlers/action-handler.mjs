...
import { COMPENDIUM_PACK_TYPES, DELIMITER, GROUP_TYPE } from "../../core/constants.mjs";
...
export class ActionHandler {
  ...
  #getMacroGroups() {
    return [this.#toGroupTagifyEntry({
      id: "macros",
      listName: `Group: ${game.i18n.localize("tokenActionHud.macros")}`,
   ...
   */
  #setCharacterLimit() {
    const groups = this.#getGroups({ level: 1 });

    for (const topLevelGroup of groups) {
